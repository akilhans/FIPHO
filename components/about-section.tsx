...
const pillars = [
  ...
  
  {
    ...
    title: "Vision",
    description:
      "To become a leading international physics olympiad that advances scientific education and honors the intellectual legacy of Ahmad al-Fergani.",
  },
  {
    icon: Globe2,
  ...
  {
    icon: BookOpen,
    title: "Legacy of Ahmad al-Fergani",
    description:
